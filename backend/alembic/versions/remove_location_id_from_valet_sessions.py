"""remove location_id from valet_sessions

Revision ID: remove_location_id
Revises: update_parking_location
...
revision = 'remove_location_id'
down_revision = 'update_parking_location'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('valet_sessions') as batch_op:
        ...
        for fk in fks:
            if 'location_id' in fk['constrained_columns']:
